  ...
  return (
    <>
      {invoiceDetailInfo.length === 0 ? (
        ...
        <>
          {" "}
          <div className="font-GeneralSans lg:px-16 sm:px-8 px-2 lg:py-8 py-8">
            <div className="w-5/5 lg:w-[65%] mx-auto">
              ...
              <div className="mt-8 p-4 flex flex-row flex-wrap items-center justify-between gap-2 bg-white shadow-[0_0px_4px_-1.76px_rgba(0,0,0,0.3)] rounded-lg">
                <div className="flex sm:flex-row flex-col sm:items-center items-start justify-between w-full gap-4">
                  ...
                  <div className="lg:mt-0 mt-3 w-full flex flex-row items-center lg:justify-end sm:justify-end justify-start gap-4">
                    ...
                    <div
                      onClick={markAsPaid}
                      className="px-5 py-2 bg-green-100/40 text-sm font-semibold rounded-full cursor-pointer"
                    >
                      Mark as Paid
                    </div>
                  </div>
              ...
              <div className="mt-6 lg:p-8 p-4 flex flex-row flex-wrap items-center justify-between gap-2 bg-white shadow-[0_0px_4px_-1.76px_rgba(0,0,0,0.3)] rounded-lg">
                <div className="flex sm:flex-row flex-col sm:items-start items-start justify-between w-full gap-4">
                  ...
                  <div className="lg:text-end text-start text-[0.95em] text-slate-600">
                    <p>
                      {invoiceDetailInfo.invoiceInfo.details.streetAddressFrom}
                    </p>
                ...
                <div className="mt-4 grid grid-cols-8 gap-4 w-full">
                  <div className="lg:col-span-2 sm:col-span-4 col-span-8">
                    ...
                    <p className="text-slate-600 text-[0.95em]">
                      {new Date(
                  ...
                  <div className="lg:col-span-2 sm:col-span-4 col-span-8">
                    <div className="mt-4 text-base text-black font-semibold lg:text-end text-start">
                      Address
                    </div>
                    <div className="lg:text-end text-start text-[0.95em] text-slate-600">
                      <p>
                        {invoiceDetailInfo.invoiceInfo.details.streetAddressTo}
                      </p>
                ...
                <div className="mt-8 bg-slate-100/50 w-full lg:p-6 p-4 rounded-xl">
                    ...
                    <table className="table-auto overflow-x-auto w-full divide-y divide-gray-100 text-sm">
                      <thead>
                        <tr className="text-[#9CA4AB] flex flex-row items-center justify-between mb-3 gap-4">
                          <th className="w-40 text-start font-semibold">
                            Name
                          </th>
                          <th className="w-20 text-center font-semibold">
                            Quantity
                          </th>
                          <th className="w-20 text-end font-semibold">Price</th>
                          <th className="w-20 text-end font-semibold">Total</th>
                        </tr>
                      </thead>
                      <tbody className="text-base divide-y divide-gray-100">
                            ...
                            return (
                              <Fragment key={index}>
                                <tr className="flex flex-row items-center justify-between py-[0.73rem] gap-3">
                                  ...
                                  <td className="w-20 text-center text-[#737373]">
                                    {data.quantity}
                                  </td>
                                  <td className="w-20 text-end font-semibold">
                                    ₦{" "}
                        ...
                        <tr className="mt-6 bg-slate-700 text-white sm:py-4 py-3 px-4 flex flex-row items-center justify-between gap-3 rounded-lg">
